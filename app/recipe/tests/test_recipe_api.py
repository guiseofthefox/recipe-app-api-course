...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_basic_recipe(self):
        ...
        for k, v in payload.items():
            # getattr returns the value of the attribute (like recipe.title)
    ...
    def test_full_update(self):
        ...
        original_link = 'http://example.com/recipe.pdf'
        new_link = 'http://example.com/recipe2.pdf'
    ...
    def test_create_recipe_with_new_tags(self):
        """Test created a recipe with new tags"""
        payload = {
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test created a recipe with existing tags"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test created a recipe with new ingredients"""
        payload = {
            'title': 'Thai Prawn Curry',
            'time_minutes': 20,
            'price': Decimal('7.50'),
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """Test created a recipe with existing ingredients"""
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_prawns)
        ...
        self.assertNotIn(ingredient_prawns, recipe.ingredients.all())
